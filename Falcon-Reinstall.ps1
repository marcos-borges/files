...
begin {
    ...
    if (Get-ItemProperty ("HKLM:\SYSTEM\CrowdStrike\{9b03c1d9-3138-44ed-9fae-d9f4c034b88d}\{16e0423f-7058-48c9-a204-725362b67639}\Default") -Name PW -ErrorAction SilentlyContinue ) {
        $PW = ([System.BitConverter]::ToString(((Get-ItemProperty ("HKLM:\SYSTEM\CrowdStrike\" +
        "{9b03c1d9-3138-44ed-9fae-d9f4c034b88d}\{16e0423f-7058-48c9-a204-725362b67639}" +
        "\Default") -Name PW -ErrorAction SilentlyContinue).PW)).ToLower() -replace '-','')
    }
...
process {
    ...
    if ($PW -and -not $BulkToken -and ((Get-ItemProperty ("HKLM:\SYSTEM\CurrentControlSet\Services\CSAgent\Sim") -Name PW -ErrorAction SilentlyContinue) -or (Get-ItemProperty ("HKLM:\SYSTEM\CrowdStrike\{9b03c1d9-3138-44ed-9fae-d9f4c034b88d}\{16e0423f-7058-48c9-a204-725362b67639}\Default") -Name PW -ErrorAction SilentlyContinue))) {
        $Param = @{
